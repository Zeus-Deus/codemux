        ...
        {queued ? (
          <div className="relative flex h-4 items-center justify-end pr-0.5">
            <div className="mr-2 flex items-center gap-2">
              {onSteerQueued && <button type="button" aria-label="Steer with queued message" title="Guide the current task without stopping tools" onClick={() => onSteerQueued(queued.queuedId)} className="rounded px-1 text-caption text-muted-foreground hover:text-foreground focus-visible:ring-1 focus-visible:ring-ring">Steer</button>}
              {onSendQueuedNow ? (
                <button
                  type="button"
                  ...
                  className="inline-flex items-center gap-1 rounded px-1 text-caption text-muted-foreground hover:bg-muted/60 hover:text-foreground focus-visible:ring-1 focus-visible:ring-ring"
                >
