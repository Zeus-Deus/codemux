...
export const FOOTER_TRIGGER =
  "inline-flex h-[34px] shrink-0 items-center gap-2 rounded-lg px-2.5 text-body font-medium leading-5 text-muted-foreground transition-colors outline-none hover:bg-foreground/[0.06] hover:text-foreground disabled:opacity-50";
