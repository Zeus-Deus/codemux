  ...
  return (
    ...
    >
      <ScrollAreaPrimitive.Viewport
        ...
        className="size-full rounded-[inherit] transition-[color,box-shadow] duration-100 outline-none focus-visible:ring-2 focus-visible:ring-ring/60 focus-visible:outline-1"
      >
        {children}
      </ScrollAreaPrimitive.Viewport>
      <ScrollBar />
