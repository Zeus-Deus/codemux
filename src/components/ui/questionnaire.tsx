...
function QuestionnaireProgress({
  ...
  return (
    <QuestionnairePrimitive.Progress
      ...
      className={cn(
        "min-h-[1lh] w-fit min-w-[14ch] text-label font-medium text-muted-foreground tabular-nums",
        className
      )}
      {...props}
    />
...
function QuestionnaireTitle({
  ...
  return (
    <QuestionnairePrimitive.Title
      ...
      className={cn(
        "font-heading text-body-lg leading-snug font-medium text-pretty [&:not(:has(~[data-slot=questionnaire-description]))]:mb-4",
        className
      )}
      {...props}
    />
...
function QuestionnaireChoice({
  ...
  return (
    <QuestionnairePrimitive.Choice
      ...
      className={cn(
        "group/questionnaire-choice relative flex min-h-11 cursor-pointer items-start gap-2.5 rounded-lg border border-input bg-transparent px-3 py-2.5 text-start text-body transition-colors duration-100 select-none hover:bg-muted/50 has-[>input:focus-visible]:border-ring has-[>input:focus-visible]:ring-3 has-[>input:focus-visible]:ring-ring/50 data-invalid:border-destructive dark:bg-input/20 data-checked:border-primary/40 data-checked:bg-muted dark:data-checked:bg-muted",
    ...
    >
      ...
      <QuestionnairePrimitive.ChoiceShortcut
        ...
        className="pointer-events-none ms-auto hidden size-5 shrink-0 translate-y-[--spacing(0.45)] items-center justify-center rounded-md border border-input bg-background font-mono text-micro leading-none font-medium text-muted-foreground group-has-data-[slot=questionnaire-choice-description]/questionnaire-choice:translate-y-0.5 group-data-[shortcut]/questionnaire-choice:inline-flex"
      />
    </QuestionnairePrimitive.Choice>
  )
}
...
function QuestionnaireError({
  ...
  return (
    <QuestionnairePrimitive.Error
      ...
      className={cn("mt-2 text-body text-destructive", className)}
      {...props}
    />
  )
}
