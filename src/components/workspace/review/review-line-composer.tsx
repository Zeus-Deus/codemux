    ...
    >
      ...
      <div className="flex flex-col gap-2 px-2.5 py-2">
        <textarea
          ...
          className={cn(
            "w-full resize-y rounded-md border-0 bg-background px-2 py-2 font-sans leading-relaxed text-foreground outline-none placeholder:text-muted-foreground focus-visible:ring-2 focus-visible:ring-ring/60",
            tzBodyLg,
          )}
        />
