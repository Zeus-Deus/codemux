...
- Read next: `docs/features/skills-sync.md` (canonical current behavior), `docs/research/step-10-skills-sync-research.md` (design rationale), `docs/archive/step-10-ui-smoke-checklist.md` (operator UI smoke checklist).
...
- **Files written across the 6 stages** (Step 10 net additions, both directions):
  ...
  - Docs: `docs/features/skills-sync.md` (new — canonical behavior), `docs/archive/step-10-ui-smoke-checklist.md` (new — operator checklist), updates to `docs/core/{STATUS,PLAN}.md`, `docs/INDEX.md`, this plan doc.
