...
- Rich chat links (generic external `http(s)` link favicons, safe-link behavior preserved, globe fallback; unreleased after `v0.15.5`): `docs/features/agent-chat.md` (§ Rich external links in chat)
