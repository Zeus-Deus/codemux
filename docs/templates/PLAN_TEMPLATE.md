...
- Purpose: Track active implementation work and next-step decisions for one subsystem.
- Audience: Anyone actively changing this area.
...
Write the current goal in one short paragraph.
