...
Unreleased after `v0.17.1` — the current Canvas-6 work plus five merged PRs
(#257–#261), grouped by subsystem below. Everything in this block is current
checkout behavior and has not shipped in a published build:
