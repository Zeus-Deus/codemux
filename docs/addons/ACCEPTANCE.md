...
| Updates | Lifecycle tests: eight durable interruptions, actual SQLite full, candidate failure, matching-data rollback, cancelled review, uninstall serialization | Dedicated 16 MiB tmpfs ENOSPC test pending CI; active-host desktop update/rollback races |
