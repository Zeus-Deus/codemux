...
| Updates | Lifecycle tests: eight durable interruptions, actual SQLite full, candidate failure, matching-data rollback, cancelled review, uninstall serialization | Six actual ENOSPC checkpoints pass on Linux, as do installed active-host update, expanded-access cancellation and matching-data rollback; Windows updated-installer repeat remains |
